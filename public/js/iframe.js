...
(function ($) {
    ...
    if (config.view != 'no') {
        ...
        $d.innerHTML = '<iframe referrerpolicy="origin" id="dsq-app8967" name="dsq-app8967" allowtransparency="true"' + ' frameborder="0"' + ' scrolling="no" tabindex="0" title="oneday" width="100%" src="' + src + '" horizontalscrolling="no" verticalscrolling="no"></iframe>';
